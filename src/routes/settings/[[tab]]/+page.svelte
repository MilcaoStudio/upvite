...
<UprisingApp>
    {#if isTouch}
        <Header palette="primary" withTransparency>
            ...
            <IconButton
                onClick={() => {
                    index + 1 < history.length && goto(history[++index]);
                }}
            >
                <RightArrow size={24} />
            </IconButton>
    ...
    <Row>
        {#if isVertical}
            {#if tab}
                <ScrollerContent>
                    ...
                    {@const SvelteComponent = Pages[tab]}
                    <SvelteComponent />
                </ScrollerContent>
            {:else}
                <!--TODO-->
                <SettingsMenu>
                    ...
                    <Item href="settings/appearance" large active>
                        {#snippet svg()}
                            ...
                            >
                                            {/snippet}
                        {$t("app.settings.pages.appearance.title")}</Item
                    >
                    ...
                    <Item href="settings/language" large active>
                        {#snippet svg()}
                            ...
                            >
                                            {/snippet}
                        {$t("app.settings.pages.language.title")}</Item
                    >
        ...
        {:else}
            ...
            <ScrollerContent>
                <h1>
                    {$t(`app.settings.pages.${tab}.title`, { default: tab })}
                </h1>
